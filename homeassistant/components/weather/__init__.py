...
class WeatherEntity(Entity):
    ...
    def state_attributes(self):
        ...
        data = {
            ATTR_WEATHER_TEMPERATURE: show_temp(self.hass, self.temperature, self.temperature_unit, self.precision),
        ...
        if self.forecast is not None:
            ...
            for forecast_entry in self.forecast:
                ...
                forecast_entry[ATTR_FORECAST_TEMP] = show_temp(self.hass,
                    forecast_entry[ATTR_FORECAST_TEMP], self.temperature_unit, self.precision)
